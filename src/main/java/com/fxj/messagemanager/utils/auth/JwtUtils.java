package com.fxj.messagemanager.utils.auth;

import com.fxj.messagemanager.entity.dao.user.User;
import com.fxj.messagemanager.mapper.user.UserMapper;
...
public class JwtUtils {
     ...
     * 加密密钥
     */
    private static final String KEY = "SnowMoon";
    ...
    public static int verify(String token, HttpServletRequest request){
        UserMapper userMapper = getBean(UserMapper.class, request);
        Claims claims = null;
        try {
        ...
        User user = userMapper.selectById(Integer.parseInt(claims.getId()));
